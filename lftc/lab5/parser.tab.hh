...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_EQUALS || tok == token::TOK_MINUS || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_LBRACKET || tok == token::TOK_RBRACKET || tok == token::TOK_RARR || tok == token::TOK_LARR || tok == token::TOK_ARROW || tok == token::TOK_SEMICOLON || tok == token::TOK_KWFOR || tok == token::TOK_KWCIN || tok == token::TOK_KWCOUT || tok == token::TOK_KWIF || tok == token::TOK_KWELSE || tok == token::TOK_KWWHILE || tok == token::TOK_KWSTRUCT || tok == token::TOK_KWSTRING || tok == token::TOK_KWINT || tok == token::TOK_KWCHAR || tok == token::TOK_LT || tok == token::TOK_GT || tok == token::TOK_EQ || tok == token::TOK_LE || tok == token::TOK_GE || tok == token::TOK_NE);
      }
#else
      ...
      symbol_type (int tok, std::string v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YY_ASSERT (tok == token::TOK_IDENTIFIER || tok == token::TOK_STRING || tok == token::TOK_CHAR);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_RARR (location_type l)
      {
        return symbol_type (token::TOK_RARR, std::move (l));
      }
#else
      static
      symbol_type
      make_RARR (const location_type& l)
      {
        return symbol_type (token::TOK_RARR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LARR (location_type l)
      {
        return symbol_type (token::TOK_LARR, std::move (l));
      }
#else
      static
      symbol_type
      make_LARR (const location_type& l)
      {
        return symbol_type (token::TOK_LARR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_KWFOR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_KWFOR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_KWCIN (location_type l)
      {
        return symbol_type (token::TOK_KWCIN, std::move (l));
      }
#else
      static
      symbol_type
      make_KWCIN (const location_type& l)
      {
        return symbol_type (token::TOK_KWCIN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_KWCOUT (location_type l)
      {
        return symbol_type (token::TOK_KWCOUT, std::move (l));
      }
#else
      static
      symbol_type
      make_KWCOUT (const location_type& l)
      {
        return symbol_type (token::TOK_KWCOUT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_KWIF, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_KWIF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_KWELSE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_KWELSE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_KWWHILE, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_KWWHILE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_KWSTRUCT, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_KWSTRUCT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_KWSTRING, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_KWSTRING, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_KWINT, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_KWINT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_KWCHAR (location_type l)
      {
        return symbol_type (token::TOK_KWCHAR, std::move (l));
      }
#else
      static
      symbol_type
      make_KWCHAR (const location_type& l)
      {
        return symbol_type (token::TOK_KWCHAR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
